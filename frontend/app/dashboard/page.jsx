								...
								{stats.recentTasks.length > 0 ? (
									...
									>
										{stats.recentTasks.map((task) => (
											<motion.div
												key={task._id}
												className="flex items-center justify-between p-3 rounded-lg border hover:bg-secondary/50 transition-colors dark:hover:bg-secondary/10"
					...
					>
						...
						<CardContent>
							<p className="text-sm leading-relaxed dark:text-primary-foreground/90 text-primary">
								Break down large tasks into smaller, manageable pieces. This
								makes them less overwhelming and helps you track progress more
								effectively. Try using priority levels to focus on what matters
								most!
							</p>
						</CardContent>
					</MotionCard>
