							...
							>
								...
								>
									<div className="relative group">
										<IconSearch className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground pointer-events-none z-10" />
										<MotionInput
											id="searchQuery"
											type="text"
						...
						>
							{filteredTasks.map((task, index) => {
								...
								return (
									...
									>
										<MotionCard
											className="group h-full border hover:border-primary/60"
											whileTap={{ scale: 0.99 }}
											whileHover={{
												y: -8,
